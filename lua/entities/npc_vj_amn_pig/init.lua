...
-----------------------------------------------*/
ENT.Model = {"models/cpthazama/amnesia/wretch.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 175
...
ENT.Enemy_Type = 0
ENT.Tracks = {
	[1] = "music/wretch_search.wav",
	[2] = "music/wretch_attack.wav",
